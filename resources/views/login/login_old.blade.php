    ...
    <body class='login theme-green'>
        <div class="wrapper">
            ...
            <div class="login-body">
                ...
                @endif
                <form action="{{URL::to('login')}}" method='POST' class='form-validate' id="test">
                    ...
                    <div class="submit">
                        <div class="remember">
                            <input type="checkbox" name="remember" style="float: left;" class='check-me' data-skin="square" data-color="blue" id="remember">
                            <label for="remember">Remember me</label>
                        </div>

                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="submit" value="Sign me in" class='btn btn-success'>
                    </div>
                </form>
                <div class="forget">
