        ...
        <div class="col-md-4  table-position">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12">
                    {!! Form::select('call_status',[''=>'--- Call Status ---']+\App\Poultry::getScheduleSuveillance(),Input::old('call_status',isset($question->call_status)?$question->call_status:''), array('id' => 'call_status', 'class' => 'form-control')) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12">
                    <input type="time" name="time" id="time" class="form-control" required="required" value="<?=date('h:m')?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="wizard-content">
                    ...
                    <div class="wizard-pane" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                {!! Form::number('i_5_2_a_value', Input::old('i_5_2_a_value',isset($question->i_5_2_a_value)?$question->i_5_2_a_value:''),array('id'=>'i_5_2_a_value','class' => 'form-control','placeholder'=>'Days Ago','min'=>0)) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                @if(isset($question->i_5_5_a_value)&&$question->i_5_5_a_value!=null)
                                    @for($q=0;$q<3;$q++)
                                        {!! Form::number('i_5_5_a_value', Input::old('i_5_5_a_value',isset(json_decode($question->i_5_5_a_value)[$q])?json_decode($question->i_5_5_a_value)[$q]:''),array('id'=>'i_5_5_a_value','class' => 'form-control i_5_5_a_value','placeholder'=>'Days Ago','min'=>0)) !!}
                                    ...
                                    @endfor
                                @else
                                    {!! Form::number('i_5_5_a_value', Input::old('i_5_5_a_value'),array('id'=>'i_5_5_a_value','class' => 'form-control i_5_5_a_value','placeholder'=>'Days Ago','min'=>0)) !!}
                    ...
                    <div class="wizard-pane" role="tabpanel">
                        ...
                        <div class="form-group">
                            <label class="col-xs-4 control-label">D.6.6.b {{ @App\Poultry::questionText()['d_6_5_b']}}</label>
                            <div class="col-xs-4">
                        ...
                        <div class="form-group">
                            <label class="col-xs-4 control-label">D.6.6.c {{ @App\Poultry::questionText()['d_6_5_c']}}</label>
                            <div class="col-xs-4">
