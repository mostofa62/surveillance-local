                    ...
                    <table class="table table-hover color-bordered-table muted-bordered-table usertable" align="center">
                        ...
                        @foreach ($dengues as $dengue)
                            <tr>
                                ...
                                <td class="noPrint">
                                    <div class="btn-group">
                                        <a href="{{ URL::to(session('access').'suspected-dengue/'.$dengue->id) }}"
                                           class="btn btn-xs btn-info"><i class="fa fa-info-circle"> </i> </a>
                                        <a href="{{ URL::to(session('access').'suspected-dengue/'.$dengue->id.'/edit') }}" class="btn btn-xs btn-primary"><i class="fa fa-edit"> </i> </a>
