                        ...
                        <div class="col-md-6 col-sm-12" id="call_recieved">
                            ...
                            <div class="form-group">
                               <label class="control-label ">Schedule Date</label>
                                <input type="date" name="date" id="date" class="form-control" required="required" value="<?=date("Y-m-d",strtotime("+1 day"));?>">
                            </div>
                            <div class="form-group">
                                <label class="control-label ">Schedule Time</label>
                                <input type="time" name="time" id="time" class="form-control" required="required" value="<?=date("H:i",strtotime("+1 day"));?>">
                            </div>
