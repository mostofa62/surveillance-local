...
@section('content')
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-hover table-bordered" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><span>{{@$info->supervisor->username}}</span></td>
                                </tr>
                                <tr>
                        ...
                        @if($info->site_ids!=NULL && is_array($info->site_ids))
                        <div class="col-md-3">
                            <table class="table table-hover table-bordered" align="center">
                                <tr>
                                    <th>Site name</th>
                                </tr>
                                @foreach(\App\Site::whereIn('id', [implode(',', json_decode(@$info->site_ids))])->pluck('name','name')->toArray() as $sid)
                                    <tr>
                                        <td>{{@$sid->name}}</td>
                                    </tr>
                                @endforeach
    ...
    <script>
        ...
        function printIt() {
           ...
           mywindow.document.write('<h4 style="text-align: center">Project Details</h4>');
