        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => isset($poultry)?session('access').'poultry/'.$poultry->id :session('access').'poultry','id'=>'form','method' => isset($poultry)?'put':'post',  'enctype'=>'multipart/form-data')) !!}
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group {!! $errors->first('surveillance_id')?'has-error':'' !!} clear">
                                ...
                                {!! Form::text('surveillance_id', Input::old('surveillance_id',isset($poultry->surveillance_id)?$poultry->surveillance_id:''),array('class' => 'form-control','placeholder'=>'Surveillance ID')) !!}
                            ...
                            <div class="form-group {!! $errors->first('date')?'has-error':'' !!} clear">
                                ...
                                {!! Form::text('date', Input::old('date',isset($poultry->date)?$poultry->date:''),array('class' => 'form-control datepick', 'placeholder' => 'yyyy-mm-dd')) !!}
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-group {!! $errors->first('name')?'has-error':'' !!} clear">
                                <label class="control-label clear">নাম</label>
                                {!! Form::text('name', Input::old('name',isset($poultry->name)?$poultry->name:''),array('class' => 'form-control','placeholder'=>'Name')) !!}
                            ...
                            <div class="form-group {!! $errors->first('mobile_no')?'has-error':'' !!} clear">
                                ...
                                {!! Form::text('mobile_no', Input::old('mobile_no',isset($poultry->mobile_no)?$poultry->mobile_no:''),array('class' => 'form-control','placeholder'=>'Mobile no')) !!}
