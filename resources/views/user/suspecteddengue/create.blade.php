...
@section('content')
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {!! Form::open(array('url' => isset($dengue)?session('access').'suspected-dengue/'.$dengue->id :session('access').'suspected-dengue','id'=>'form','method' => isset($dengue)?'put':'post',  'enctype'=>'multipart/form-data')) !!}
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-group {!! $errors->first('travel_date')?'has-error':'' !!} clear">
                                ...
                                {!! Form::text('travel_date', Input::old('travel_date',isset($dengue->travel_date)?$dengue->travel_date:''),array('id'=>'travel_date','class' => 'form-control datepick', 'placeholder'=>'Date of Travel')) !!}
                            ...
                            <div class="form-group {!! $errors->first('travel_day')?'has-error':'' !!} clear">
                                ...
                                {!! Form::number('travel_day', Input::old('travel_day',isset($dengue->travel_day)?$dengue->travel_day:''),array('id'=>'travel_day','min'=>0, 'max'=>31, 'class' => 'form-control', 'placeholder'=>'Days')) !!}
    ...
    <script>
        $(document).ready(function () {
            ...
            if ($('.is_travel:checked').val() == 1) {
                $('#travel_date').removeAttr("disabled");
                $('#travel_day').removeAttr("disabled");
                $('#travel_date').focus();
            }else{
                $('#travel_date').attr('disabled', 'disabled');
                $('#travel_day').attr('disabled', 'disabled');
            }
