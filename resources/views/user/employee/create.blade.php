                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="form-group {!! $errors->first('joindate')?'has-error':'' !!} clear">
                                <label class="control-label clear">Join Date</label>
                                {!! Form::text('joindate', Input::old('joindate',isset($employee->joindate)?$employee->joindate:''),array('class' => 'form-control datepick', 'id' => '', 'placeholder' => 'yyyy-mm-dd')) !!}
                                @if ($errors->first('joindate'))
                                    <div class="alert alert-danger">{!! $errors->first('joindate') !!}</div>@endif
                            </div>
                        </div>  <!-- end col-md-3 -->
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group  {!! $errors->first('dept')?'has-error':'' !!} ">
                                <label class="control-label clear"> Department</label>
                                {!! Form::select('dept',array('HR'=>'HR','Accounts'=>'Accounts','Procurement'=>'Procurement'),Input::old('dept',isset($employee->dept)?$employee->dept:''), array('id' => 'dept', 'class' => 'form-control')) !!}
                            ...
                            <div class="form-group {!! $errors->first('accesslist_id')?'has-error':'' !!}">
                                ...
                                {!! Form::select('accesslist_id[]',\App\Accesslist::withTrashed()->pluck('name', 'id')->toArray(), Input::old('accesslist_id',isset($employee->user->accesslist_id)?json_decode($employee->user->accesslist_id):''), array('multiple'=>'multiple','id' => 'accesslist_id', 'class' => ' select2 select2-multiple')) !!}
