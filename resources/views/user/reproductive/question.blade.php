...
@section('content')
    ...
    <div class="col-md-12">
		...
		<div class="col-md-4 col-sm-12  table-position" style="display: none;">
            ...
            <div class="form-group">
                <label class="col-md-12 control-label ">Schedule Type
                </label>
                    <div class="col-md-12">
                                {{-- Form::select('s_type',[''=>'--- Schedule Type ---']+\App\Models\Reproductive::getScheduleType(),Input::old('s_type',isset($reproductive->s_type)?$reproductive->s_type:''), array('id' => 's_type', 'class' => 'form-control')) --}}
            ...
            <div class="form-group">
                ...
                {!! Form::select('call_status',[''=>'--- সাক্ষাৎকার অবস্থা ---']+\App\Models\Reproductive::getForcedfinished(),Input::old('call_status',isset($question->call_state)?$question->call_status:''), array('id' => 'call_status', 'class' => 'form-control')) !!}
            </div>
			...
			<div id="exampleValidator" class="wizard">
				...
				<div class="wizard-content">
					...
					<div class="wizard-pane active" role="tabpanel">
						<div class="surveillance-data">
							...
							<div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('s_0_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPersonAge(),Input::old('s_0_3',isset($question->s_0_3)?$question->s_0_3:''), array('required'=>true,'id' => 's_0_3', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! @App\Common::radioButtonGenerate(\App\Models\Reproductive::getYesNoPossible(), 's_0_4',0,$question->s_0_4, true) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <div class="upazila">
                                        ...
                                        {!! Form::select('gi_1_3_uz',[''=>'---Upazila / Thana---']+\App\Models\Reproductive::upazilalist(isset($question->gi_1_1)?$question->gi_1_1:0),Input::old('gi_1_3_uz',isset($question->gi_1_3_uz)?$question->gi_1_3_uz:''), array('id' => 'gi_1_3_uz', 'class' => 'form-control select2')) !!}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('pi_2_2',[''=>'---Select an option---']+\App\Models\Reproductive::getPersonAge(isset($question->s_0_3)?$question->s_0_3:null),Input::old('pi_2_2',isset($question->pi_2_2)?$question->pi_2_2:''), array('required'=>true,'id' => 'pi_2_2', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('pi_2_4',[''=>'---Select an option---']+\App\Models\Reproductive::getPersonMarrigeAge(),Input::old('pi_2_4',isset($question->pi_2_2)?$question->pi_2_4:''), array('required'=>true,'id' => 'pi_2_4', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
					...
					<div class="wizard-pane" role="tabpanel">
						<p><br><strong> {{ @App\Models\Reproductive::questionText()['fp_3_i']}}</strong></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('dp_4_11_1',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatHappened(),Input::old('dp_4_11_1',isset($question->dp_4_11_1)?$question->dp_4_11_1:''), array('id' => 'dp_4_11_1', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_11_1_e', Input::old('dp_4_11_1_e',isset($question->dp_4_11_1_e)?$question->dp_4_11_1_e:''),array('id'=>'dp_4_11_1_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_11_1_e'])) !!}

                                    {!! Form::select('dp_4_11_2',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatHappened(),Input::old('dp_4_8_2',isset($question->dp_4_11_2)?$question->dp_4_11_2:''), array('id' => 'dp_4_11_2', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_11_2_e', Input::old('dp_4_11_2_e',isset($question->dp_4_11_2_e)?$question->dp_4_11_2_e:''),array('id'=>'dp_4_11_2_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_11_2_e'])) !!}

                                    {!! Form::select('dp_4_11_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatHappened(),Input::old('dp_4_11_3',isset($question->dp_4_11_3)?$question->dp_4_11_3:''), array('id' => 'dp_4_11_3', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_11_3_e', Input::old('dp_4_11_3_e',isset($question->dp_4_11_3_e)?$question->dp_4_11_3_e:''),array('id'=>'dp_4_11_3_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_11_3_e'])) !!}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('dp_4_12_1',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDo(),Input::old('dp_4_12_1',isset($question->dp_4_12_1)?$question->dp_4_12_1:''), array('id' => 'dp_4_12_1', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_12_1_e', Input::old('dp_4_12_1_e',isset($question->dp_4_12_1_e)?$question->dp_4_12_1_e:''),array('id'=>'dp_4_12_1_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_12_1_e'])) !!}

                                    {!! Form::select('dp_4_12_2',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDo(),Input::old('dp_4_12_2',isset($question->dp_4_12_2)?$question->dp_4_12_2:''), array('id' => 'dp_4_12_2', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_12_2_e', Input::old('dp_4_12_2_e',isset($question->dp_4_12_2_e)?$question->dp_4_12_2_e:''),array('id'=>'dp_4_12_2_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_12_2_e'])) !!}

                                    {!! Form::select('dp_4_12_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDo(),Input::old('dp_4_12_3',isset($question->dp_4_12_3)?$question->dp_4_12_3:''), array('id' => 'dp_4_12_3', 'class' => 'form-control select2')) !!}


                                    {!! Form::text('dp_4_12_3_e', Input::old('dp_4_12_3_e',isset($question->dp_4_12_3_e)?$question->dp_4_12_3_e:''),array('id'=>'dp_4_12_3_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_12_3_e'])) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('dp_4_13_1',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDoForSafety(),Input::old('dp_4_13_1',isset($question->dp_4_13_1)?$question->dp_4_13_1:''), array('id' => 'dp_4_13_1', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_13_1_e', Input::old('dp_4_13_1_e',isset($question->dp_4_13_1_e)?$question->dp_4_13_1_e:''),array('id'=>'dp_4_13_1_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_13_1_e'])) !!}

                                    {!! Form::select('dp_4_13_2',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDoForSafety(),Input::old('dp_4_13_2',isset($question->dp_4_13_2)?$question->dp_4_13_2:''), array('id' => 'dp_4_13_2', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_13_2_e', Input::old('dp_4_13_2_e',isset($question->dp_4_13_2_e)?$question->dp_4_13_2_e:''),array('id'=>'dp_4_13_2_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_13_2_e'])) !!}

                                    {!! Form::select('dp_4_13_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnancyWhatToDoForSafety(),Input::old('dp_4_13_3',isset($question->dp_4_13_3)?$question->dp_4_13_3:''), array('id' => 'dp_4_13_3', 'class' => 'form-control select2')) !!}

                                    {!! Form::text('dp_4_13_3_e', Input::old('dp_4_13_3_e',isset($question->dp_4_13_3_e)?$question->dp_4_13_3_e:''),array('id'=>'dp_4_13_3_e','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['dp_4_13_3_e'])) !!}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('cq_5_5',[''=>'---Select an option---']+\App\Models\Reproductive::getCancerInfectedAge(),Input::old('cq_5_5',isset($question->cq_5_5)?$question->cq_5_5:''), array('required'=>true,'id' => 'cq_5_5', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    {!! Form::number('cq_5_10_day', Input::old('cq_5_10_day',isset($question->cq_5_10_day)?$question->cq_5_10_day:''),array('min'=>'-1','id'=>'cq_5_10_day','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['cq_5_10_day'])) !!}


                                    {!! Form::number('cq_5_10_month', Input::old('cq_5_10_month',isset($question->cq_5_10_month)?$question->cq_5_10_month:''),array('min'=>'-1','id'=>'cq_5_10_month','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['cq_5_10_month'])) !!}


                                    {!! Form::number('cq_5_10_year', Input::old('cq_5_10_year',isset($question->cq_5_10_year)?$question->cq_5_10_year:''),array('min'=>'-1','id'=>'cq_5_10_year','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['cq_5_10_year'])) !!}
                                </div>
                            </div>
                    ...
                    <div class="wizard-pane" role="tabpanel">
                        ...
                        <span id="rh_6_1_pin"></span>
                        <div class="form-group">
                                <label class="col-xs-4 control-label">6.1। {{ @App\Models\Reproductive::questionText()['rh_6_1']}}</label>
                                <div class="col-xs-4">
                                    {!! Form::select('rh_6_1',[''=>'---Select an option---']+\App\Models\Reproductive::getMasikFirstInfectedAge(isset($question->s_0_3)?$question->s_0_3:null),Input::old('rh_6_1',isset($question->rh_6_1)?$question->rh_6_1:''), array('required'=>true,'id' => 'rh_6_1', 'class' => 'form-control select2')) !!}
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-xs-4 control-label">6.12। {{ @App\Models\Reproductive::questionText()['rh_6_12']}}</label>
                                <div class="col-xs-4">
                                    {!! @App\Common::radioButtonGenerate(\App\Models\Reproductive::getYesNoDontKnow(), 'rh_6_12',0,$question->rh_6_12, true) !!}
                                    
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-xs-4 control-label">6.13। {{ @App\Models\Reproductive::questionText()['rh_6_13']}}</label>
                                <div class="col-xs-4">
                                    {!! Form::select('rh_6_13',[''=>'---Select an option---']+\App\Models\Reproductive::getPinkDressCalled(),Input::old('rh_6_13',isset($question->rh_6_13)?$question->rh_6_13:''), array('id' => 'rh_6_13', 'class' => 'form-control select2')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('bc_7_2',[''=>'---Select an option---']+\App\Models\Reproductive::getBirthControlChildNumber(),Input::old('bc_7_2',isset($question->bc_7_2)?$question->bc_7_2:''), array('required'=>true,'id' => 'bc_7_2', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
                    ...
                    <div class="wizard-pane" role="tabpanel">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('prq_8_2',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnantNoOfService(),Input::old('prq_8_2',isset($question->prq_8_2)?$question->prq_8_2:''), array('required'=>true,'id' => 'prq_8_2', 'class' => 'form-control select2')) !!}
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('prq_8_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPersonAge(isset($question->s_0_3)?$question->s_0_3:null),Input::old('prq_8_3',isset($question->prq_8_3)?$question->prq_8_3:''), array('required'=>true,'id' => 'prq_8_3', 'class' => 'form-control select2')) !!}
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    {!! Form::number('rprq_9_3_day', Input::old('rprq_9_3_day',isset($question->rprq_9_3_day)?$question->rprq_9_3_day:''),array('min'=>'-1','id'=>'rprq_9_3_day','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['rprq_9_3_day'])) !!}


                                    {!! Form::number('rprq_9_3_month', Input::old('rprq_9_3_month',isset($question->rprq_9_3_month)?$question->rprq_9_3_month:''),array('min'=>'-1','id'=>'rprq_9_3_month','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['rprq_9_3_month'])) !!}


                                    {!! Form::number('rprq_9_3_year', Input::old('rprq_9_3_year',isset($question->rprq_9_3_year)?$question->rprq_9_3_year:''),array('min'=>'-1','id'=>'rprq_9_3_year','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['rprq_9_3_year'])) !!}
                                </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    {!! Form::number('pprq_10_1_day', Input::old('pprq_10_1_day',isset($question->pprq_10_1_day)?$question->pprq_10_1_day:''),array('min'=>'-1','max'=>31,'id'=>'pprq_10_1_day','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['pprq_10_1_day'])) !!}


                                    {!! Form::number('pprq_10_1_month', Input::old('pprq_10_1_month',isset($question->pprq_10_1_month)?$question->pprq_10_1_month:''),array('min'=>'-1','max'=>12,'id'=>'pprq_10_1_month','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['pprq_10_1_month'])) !!}


                                    {!! Form::number('pprq_10_1_year', Input::old('pprq_10_1_year',isset($question->pprq_10_1_year)?$question->pprq_10_1_year:''),array('min'=>'-1','id'=>'pprq_10_1_year','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['pprq_10_1_year'])) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('pprq_10_3',[''=>'---Select an option---']+\App\Models\Reproductive::getPregnantNoOfTimes(90),Input::old('pprq_10_3',isset($question->pprq_10_3)?$question->pprq_10_3:''), array('required'=>true,'id' => 'pprq_10_3', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! @App\Common::radioButtonGenerate(\App\Models\Reproductive::getYesNoDontKnow(), 'pprq_10_21',0,$question->pprq_10_21, true) !!}
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label">10.22। {{ @App\Models\Reproductive::questionText()['pprq_10_22']}}</label>
                                <div class="col-xs-4">
                                    {!! @App\Common::radioButtonGenerate(\App\Models\Reproductive::getYesNoDontKnow(), 'pprq_10_22',0,$question->pprq_10_22, true) !!}
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label">10.23। {{ @App\Models\Reproductive::questionText()['pprq_10_23']}}</label>
                                <div class="col-xs-4">
                                    {!! Form::select('pprq_10_23',[''=>'---Select an option---']+\App\Models\Reproductive::getPinkDressCalled(),Input::old('pprq_10_23',isset($question->pprq_10_23)?$question->pprq_10_23:''), array('id' => 'pprq_10_23', 'class' => 'form-control select2')) !!}
                            ...
                            <div class="form-group">
                                <label class="col-xs-4 control-label">10.24। {{ @App\Models\Reproductive::questionText()['pprq_10_24']}}</label>
                                <div class="col-xs-4">
                                    {!! @App\Common::radioButtonGenerate(\App\Models\Reproductive::getYesNoDontKnow(), 'pprq_10_24',0,$question->pprq_10_24, true) !!}
                    ...
                    <div class="wizard-pane" role="tabpanel">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    {!! Form::number('fq_11_3_day', Input::old('fq_11_3_day',isset($question->fq_11_3_day)?$question->fq_11_3_day:''),array('min'=>'-1','id'=>'fq_11_3_day','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['fq_11_3_day'])) !!}


                                    {!! Form::number('fq_11_3_month', Input::old('fq_11_3_month',isset($question->fq_11_3_month)?$question->fq_11_3_month:''),array('min'=>'-1','id'=>'fq_11_3_month','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['fq_11_3_month'])) !!}


                                    {!! Form::number('fq_11_3_year', Input::old('fq_11_3_year',isset($question->fq_11_3_year)?$question->fq_11_3_year:''),array('min'=>'-1','id'=>'fq_11_3_year','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['fq_11_3_year'])) !!}
                                </div>
                        </div>
                        ...
                        <p><br><strong> {{ @App\Models\Reproductive::questionText()['fqi_12_i']}}</strong></p>
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    {!! Form::text('fqi_12_1_father', Input::old('fqi_12_1_father',isset($question->fqi_12_1_father)?$question->fqi_12_1_father:''),array('id'=>'fqi_12_1_father','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['fqi_12_1_father'])) !!}

                                    {!! Form::text('fqi_12_1_husband', Input::old('fqi_12_1_husband',isset($question->fqi_12_1_husband)?$question->fqi_12_1_husband:''),array('id'=>'fqi_12_1_husband','class' => 'form-control','placeholder'=>@App\Models\Reproductive::questionText()['fqi_12_1_husband'])) !!}
    ...
    <script src="{{URL::to('resources/assets/js/reproductive/easytimer.min.js')}}"></script>
