...
<li> কথা শুরু করে, কিছু প্রশ্নের পর, এমনকি একবার সময় নির্ধারণের পরও কল সম্পন্ন করা না গেলে ”সম্পূর্ণ করুন” চাপুন।</li>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    {!! Form::select('s_0_3',[''=>'---Select an option---']+\App\Models\Ivr::getPersonAge(),Input::old('s_0_3',isset($question->s_0_3)?$question->s_0_3:''), array('required'=>true,'id' => 's_0_3', 'class' => 'form-control select2')) !!}
                                </div>
                            </div>
					...
					<div class="wizard-pane" role="tabpanel">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                	<ul style="background-color: #3184ad;color:#fff;">
                                		<li> কথা শুরু করে, সকল প্রশ্ন শেষ করলে ”সম্পূর্ণ” চাপুন।</li>
                                	</ul>
                                </div>
                        </div>
