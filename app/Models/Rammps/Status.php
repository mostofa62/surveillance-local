...
Homeopathy Physicians  19',
    ...
    public static function s_3_child_health_decesion($unset=null){
        $data =  [
            ...
            9 => '9 পরিবার (বাবা-মা, ভাই-বোন, ছেলে-মে',
            10 => '10 আত্মীয়(মামা-খালা,চাচা-চাচি,ফুপু-ফুপা',
    ...
    public static function s_7_owner_phone($unset=null){
        $data =  [
            1 => '1 উত্তর দাতা নিজেই',
            2 => '2 স্বামী / স্ত্রী /সঙ্গী',
            3 => '3 উত্তরদাতা এবং স্বামী/সঙ্গী যৌথভাবে',
            4 => '4 পরিবার/আত্মীয়',
            5 => '5 উত্তরদাতা এবং পরিবার/আত্মীয় যৌথভাবে',
            6 => '6 অন্য কেউ',
            7 => '7 উত্তরদাতা এবং অন্য কেউ যৌথভাবে',
            99 => '99 অস্বীকৃতি',
        ];
    ...
    public static function ignoreReason(){
    	...
    	return [
            ...
            14 =>'14 রেজিস্ট্রেশন হয়নি / মেসেজ পাইনি',
			66 => '66 অন্যান্য (উল্লেখ করুন )',
			88 => '88 জানি না',
